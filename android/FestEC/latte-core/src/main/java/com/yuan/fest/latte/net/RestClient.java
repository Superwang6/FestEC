...
import com.yuan.fest.latte.net.callback.RequestCallbacks;
import com.yuan.fest.latte.net.download.DownloadHandler;
...
public class RestClient {
    ...
    public RestClient(String url, Map<String, Object> params, IRequest request,String downloadDir, String extension, String name, ISuccess success, IFailure failure
            , IError error, RequestBody body, File file, LoaderStyle loaderStyle, Context context) {
        this.URL = url;
    ...
    private void request(HttpMethod method) {
        ...
        switch (method) {
            ...
            case DELETE:
                ...
                break;
            case UPLOAD:
                final RequestBody requestBody = RequestBody.create(MediaType.parse(String.valueOf(MultipartBody.FORM)), FILE);
